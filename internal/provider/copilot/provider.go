...
// Provider loads GitHub Copilot CLI usage entries.
...
func (Provider) Provider() usage.Provider { return usage.ProviderCopilot }

// WithFileFilter returns a GitHub Copilot CLI provider that skips source files the
// filter rejects.
